...
@movement1 = Movement.create(name: "Neck", section: "Head")
@movement2 = Movement.create(name: "Nose", section: "Head")
@movement3 = Movement.create(name: "Ears", section: "Head")
@movement4 = Movement.create(name: "Mouth", section: "Head")
@movement5 = Movement.create(name: "Chin", section: "Head")
@movement6 = Movement.create(name: "Eyes", section: "Head")
@movement7 = Movement.create(name: "Forehead", section: "Head")
@movement8 = Movement.create(name: "Face", section: "Head")

@movement9 = Movement.create(name: "Shoulder", section: "Upper_Body")
@movement10 = Movement.create(name: "Chest", section: "Upper_Body")
@movement11 = Movement.create(name: "Upper Back", section: "Upper_Body")
@movement12 = Movement.create(name: "Upper Arm", section: "Upper_Body")
@movement13 = Movement.create(name: "Forearm", section: "Upper_Body")
@movement14 = Movement.create(name: "Hands", section: "Upper_Body")

@movement15 = Movement.create(name: "Abdominals", section: "Core")
@movement16 = Movement.create(name: "Lower Back", section: "Core")
@movement17 = Movement.create(name: "Obliques", section: "Core")
@movement18 = Movement.create(name: "Transverse", section: "Core")

@movement19 = Movement.create(name: "Hips", section: "Lower_Body")
@movement20 = Movement.create(name: "Upper Leg", section: "Lower_Body")
@movement21 = Movement.create(name: "Lower Leg", section: "Lower_Body")
@movement22 = Movement.create(name: "Feet", section: "Lower_Body")

@movement23 = Movement.create(name: "Swinging", section: "Movement")
@movement24 = Movement.create(name: "Strength", section: "Movement")
@movement25 = Movement.create(name: "Endurence", section: "Movement")
@movement26 = Movement.create(name: "Power/Plyo", section: "Movement")
@movement27 = Movement.create(name: "Body Weight", section: "Movement")
@movement28 = Movement.create(name: "Climbing", section: "Movement")
@movement29 = Movement.create(name: "Swimming", section: "Movement")
@movement30 = Movement.create(name: "Gracefulness", section: "Movement")
@movement31 = Movement.create(name: "Meditation", section: "Movement")
@movement32 = Movement.create(name: "Mobility", section: "Movement")
@movement33 = Movement.create(name: "Balance", section: "Movement")
@movement34 = Movement.create(name: "Iron Body", section: "Movement")
@movement35 = Movement.create(name: "Tumbling", section: "Movement")
